    ...
    function init(element, options) {
      ...
      function start() {
        ...
        function onAnimationExpired() {
          ...
          // should still continue normally as if the animation Datasets correctly.
          close();
        }
 ...
 * the CSS class once an animation has Datasets.)
 *
 *
 ...
 *     // the animation for this route has Datasets
 *   }]);
 * }])
 * ```
 *

              ...
              <table className="table-pert"  >
               ...
               <tr  >
                ...
                <tr  >
                  ...
                  <td style={{padding:".25em"}}>
                    <a href={'/signatures/signatures?signature=imaging&class=cell line&term='+sms.name}>  <b>   {sms.signatures["imaging"] ? sms.signatures["imaging"]: "-"} </b> </a>
                  </td>
                </tr>
             <tr  >
                  <th  scope="row" style={{width:"50%",padding:".25em",fontWeight:"200"}}>Cell Viability :</th>
                  <td style={{padding:".25em"}}>
                    <a href={'/signatures/signatures?signature=cell viability&class=cell line&term='+sms.name}> <b>  {sms.signatures["cell viability"] ? sms.signatures["cell viability"]: "-"}</b> </a>
                  </td>
                </tr>
                </tbody>
              </table>

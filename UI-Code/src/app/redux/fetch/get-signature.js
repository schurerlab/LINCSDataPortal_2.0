...
export function changeSignature(id) {
    return function (dispatch) {
        axios.get('http://dev3.ccs.miami.edu:8080/sigc-api-test/signature/fetch-by-id?id=' + id + '&onlyLandmarkGenes=false')
            .then((response) => {
        ...
        axios.get('http://dev3.ccs.miami.edu:8080/sigc-api-test/signature/fetch-metadata?id=' + id )
            .then((response) => {
